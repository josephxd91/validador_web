...
public class BArchivoMIS {
	...
	public String toString() {
		return "BArchivoMIS [idArchivoMIS=" + idArchivoMIS + ", idHistoricoMIS=" + idHistoricoMIS + ", cantValTotalMIS="
				+ cantValTotalMIS + ", cantValCorrMIS=" + cantValCorrMIS + ", cantValIncMIS=" + cantValIncMIS
				+ ", porcValMIS=" + porcValMIS + ", esHistorico=" + esHistorico + ", fechaMIS=" + fechaMIS + ", tkMIS="
				+ tkMIS + "]";
	}
