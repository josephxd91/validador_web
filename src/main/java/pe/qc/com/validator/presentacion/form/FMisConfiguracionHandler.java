...
public class FMisConfiguracionHandler {
	private FConfiguracionServidor fConfiguracionServidor;
	private FSeccion fSeccion;
	private FSubSeccion fSubSeccion;
	private FSubTabla fSubTabla;
	private FBalanceCarga fBalanceCargaDes;
	private FBalanceCarga fBalanceCargaCer;
	private FBalanceCarga fBalanceCargaPro;
	private List<FConfiguracionServidor> listaConfiguracion;
	private List<FBalanceCarga> listaBalanceCargaDes;
	private List<FBalanceCarga> listaBalanceCargaCer;
	private List<FBalanceCarga> listaBalanceCargaPro;
	private List<FSubTabla> listaSubtabla;
	
	public List<FConfiguracionServidor> getListaConfiguracion() {
		return listaConfiguracion;
	}
	public void setListaConfiguracion(List<FConfiguracionServidor> listaConfiguracion) {
	...
	public void convertirHandler(File f) {
		...
		try {
			...
			DefaultHandler handler = new DefaultHandler() {
				...
				int comenzarConfiguracionServidor = 0;
				...
				public void characters(char ch[], int start, int length) throws SAXException {
					...
					if (idConfiguracion) {
						...
						comenzarConfiguracionServidor = 1;
						idConfiguracion = false;
					}
					...
					if (palabra && new String(ch, start, length).length()>2) {
						if(comenzarConfiguracionServidor!=0) {
					...
					if (cierreSeccion) {
						...
						cierreSeccion = false;
						comenzarConfiguracionServidor = 0;
					}
